...
**Due Sunday, February 28 @ midnight through Github**
...
5. When you have a final data display read to go, take a screenshot or download your display and post on Piazza under the Assignment 2-1 Display thread.  You are welcome to post your screenshot anonymously to your classmates.
...
* In the window that opens, **stage** your changes by clicking the check boxes next to the `Asst2-1.Rmd` and `Asst2-1.html` files.
